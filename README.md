...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/BdkFB2o3DJ)
...
```sh
npx nx serve household
```

To create a production bundle:

```sh
npx nx build household
```

To see all available targets to run for a project, run:

```sh
npx nx show project household
```
